...
// Apple logo - official Apple guidelines require black or white color only
export const AppleLogo = ({ ariaLabelledBy }) => (
  ...
  >
    <path
      d="M15.462 10.544c-.024-2.392 1.952-3.54 2.04-3.596-1.112-1.624-2.84-1.848-3.456-1.872-1.464-.152-2.872.872-3.616.872-.752 0-1.904-.856-3.136-.832-1.608.024-3.096.944-3.92 2.392-1.68 2.912-.432 7.216 1.2 9.576.8 1.16 1.752 2.456 3 2.408 1.208-.048 1.664-.78 3.12-.78 1.448 0 1.872.78 3.144.752 1.296-.024 2.12-1.176 2.904-2.344.92-1.344 1.296-2.648 1.32-2.72-.032-.008-2.528-1.024-2.6-3.856zM13.044 3.624c.656-.808 1.104-1.92.984-3.04-1.008.04-2.232.68-2.96 1.52-.648.76-1.224 1.88-1.072 2.984 1.128.088 2.28-.544 3.048-1.464z"
      fill="#000000"
      fillRule="nonzero"
    />
  </svg>
