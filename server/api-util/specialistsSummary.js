/**
 * Сколько специалистов работает в каждой категории.
 *
 ...
 * считаем все категории за один проход.
 *
 * Живёт отдельно от эндпоинта, потому что те же цифры называет голосовой
 * помощник: карточка в мастере и голос не должны расходиться в числе мастеров.
 */
