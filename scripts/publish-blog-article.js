/**
 * Publishes a blog article module to production Postgres.
 *
 *   DATABASE_URL="$(heroku config:get DATABASE_URL --app youdu)" \
 *     node scripts/publish-blog-article.js scripts/articles/filtry-hepa-ugolnye-kondicioner-dubai.js
 */
...
if (!modulePath) {
  console.error('Usage: node scripts/publish-blog-article.js scripts/articles/<file>.js');
  process.exit(1);
}

const article = require(path.resolve(process.cwd(), modulePath));
